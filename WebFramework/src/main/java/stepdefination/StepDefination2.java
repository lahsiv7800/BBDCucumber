...
public class StepDefination2 {
	...
	public void user_navigates_through_product_categories() {
	...
	public void user_fills_web_form_and_clicks_on_purchase() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	public void user_prepares_get_request_to_get_pets_in_pet_store(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
...
//	}
	...
	public void verify_status_in_the_response_body(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	@Then("Assert newly addes pet {string} to store")
	public void assert_newly_addes_pet_to_store(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
...
//	}
	...
	public void asserts_newly_added_pets_status_in_the_response(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
